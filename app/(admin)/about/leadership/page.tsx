                  ...
                  <div className="flex flex-col sm:flex-row gap-3 items-start">
                    ...
                    <div className="flex-1 w-full space-y-2">
                      <input 
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-[14px] p-3 text-[#0F172A] outline-none focus:ring-2 focus:ring-blue-500 text-xs" 
                        value={formData.photoUrl} 
                        onChange={e => setFormData({...formData, photoUrl: e.target.value})} 
                      />

                      {/* Cloudinary Quick Upload Dropzone */}
                      <CloudinaryUploader
                        folder="cechstu_members"
                        multiple={false}
                        label="Or upload photo from device"
                        description="Uploads to Cloudinary and populates the Photo URL automatically"
